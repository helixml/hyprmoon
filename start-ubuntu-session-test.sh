...
echo "Hyprland command: /usr/bin/Hyprland --config /test_config/hyprland.conf"
/usr/bin/Hyprland --config /test_config/hyprland.conf &
COMPOSITOR_PID=$!
...
# Note: Wolf moonlight server starts with Hyprland automatically
echo "Wolf moonlight server will start with Hyprland on ports 48989/49010/48999"
