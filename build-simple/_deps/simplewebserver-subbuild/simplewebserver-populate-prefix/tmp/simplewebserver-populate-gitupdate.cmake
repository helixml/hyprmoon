...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4abe349"
  WORKING_DIRECTORY "/workspace/build-simple/_deps/simplewebserver-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/build-simple/_deps/simplewebserver-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/build-simple/_deps/simplewebserver-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
